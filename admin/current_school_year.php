    ...
    <h6 class="m-0 font-weight-bold text-primary">
      <div class="col-4 float-left">
            <p> 
                <?php
                    ...
                    $CompleteSchoolYear = $schoolyearCurrent . " - " . $schoolyearAdd;
                ?>
                School Year: <?php echo $CompleteSchoolYear; ?>
            </p>
      </div>
      ...
      <div class="col-4 float-right">
              <select name="SchoolYear" class="form-control" onchange="location = this.value;" required>
                <option selected disabled value="current_school_year.php">Current School Year</option>
                <option value="Student.php">Default</option>
                <option value="old_school_year.php">OLd School Year</option>
            </select>
      </div>
...
<td width="2%">
  ...
  <td width="2%">
            <form action="edit_student.php" method="post">
                    <input type="hidden" name="edit_yearId" value="2">
