...
?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Camera 8</h1>
    ...
    <div class="row d-flex justify-content-center text-center">
        ...
        <div class="col-4">
                <select name="Camera" class="form-control" onchange="location = this.value;">
                    <option value="index.php">Default Camera</option>
                    ...
                    <option value="camera8.php" selected >Camera 8</option>
                </select>
        </div>
    ...
    <form role="form" action="code.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="cameranumber" value="8">
            </div>
